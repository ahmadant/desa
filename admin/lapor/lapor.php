		...
		<div class="row col-sm-12 col-md-6">	
			<table class="table table-bordered table-responsive table-striped">
				...
				<tbody>
					...
					<?php
						$query = "SELECT * FROM lapor ORDER BY id_a";
						...
						while ($data = mysqli_fetch_array($exec)) {
							...
							<tr>
								...
								<td><?=$data['pesan']?></td>
								<td>
									<a href="edit.php?id=<?=$data['id_p']?>" class="btn btn-success">Edit</a>
									<a href="hapus.php?id=<?=$data['id_p']?>" class="btn btn-danger">Hapus</a>
								</td>
							</tr>
							<?php
						$no++;	
