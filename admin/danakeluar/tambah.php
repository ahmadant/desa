	...
	<div class="container">
		...
		<div class="row col-sm-12 col-md-6">	
			<form action="cek.php" method="POST" name="isidatauser" class="form-group">
				...
				<p>
					<input type="date" name="tgl_m" placeholder="yyyy-mm-dd" class="form-control">
				</p>

				<p>
					<input type="text" name="jml_m" placeholder="jumlah" class="form-control">
				</p>


				<p>
					<input type="text" name="terbilang" placeholder="terbilang" class="form-control">
				</p>
				<p>
